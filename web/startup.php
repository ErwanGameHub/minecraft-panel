...
<div class="grid">
    <section class="card full">
        <h2 class="icon-heading"><?= panel_icon('power') ?>Bedrock Startup Settings</h2>
        ...
        <form method="post" class="startup-form">
            ...
            <div class="controls form-actions">
                <button name="action" value="save_startup" class="button-success with-icon"><?= panel_icon('save') ?>Save Startup Settings</button>
